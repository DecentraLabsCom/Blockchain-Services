...
public class InstitutionRegistrationService {
     ...
     * @return true if the Marketplace confirms the remote registration, false otherwise
     */
     ...
     *
     * @param challenge pairing challenge generated by Marketplace
     * @param providerRegistrationEnabled whether this deployment permits provider registration
     */
    public ProvisioningPairingPreparation preparePairing(
        String challenge,
        boolean providerRegistrationEnabled
    ) {
        ...
        if (InstitutionRole.PROVIDER.name().equalsIgnoreCase(registrationType)
    ...
    private boolean registerAsProvider(InstitutionRegistrationRequest request) {
        ...
        try {
            ...
            log.info("Provider registration completed successfully; local configuration is committed by the controller");
    ...
    private boolean registerAsConsumer(InstitutionRegistrationRequest request) {
        ...
        try {
            ...
            log.info("Consumer registration completed successfully; local configuration is committed by the controller");
